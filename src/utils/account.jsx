export const accountQuestions = [
  {
    id: 1,
    title: <h3>Why did I stop receiving ZOX emails?</h3>,
    content: (
      <p>
  ...
  },
  {
    ...
    content: (
      <p>
        ...
        <a href="https://zox.la/account/login">here</a> and click the 'Forgot
        Password' link. That should bring you to a page to enter your email and
        a message will be sent over to set a new password.
        <br />
        <br />
